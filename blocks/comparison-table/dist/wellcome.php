	...
	function nichetablewpwp_settings_page_render() {
        ...
        <div class="nichetable_section s_1">
                            ...
                            <div class="t_row">
                                <div class="col-md-7">
                                    ...
                                    <p>&#10140; Create a new page or post and click on the <img
                                                src="https://wpdab.com/img/nichetable/editor-plus-icon.svg" alt="img">
                                        button to add a block</p>
                                    <p>&#10140; Scroll down and pick a NicheTable block and customize it!</p>
                                </div>
                                <div class="col-md-5">
                                    <img class="importimg" src="https://wpdab.com/img/nichetable/nichetable-block.gif"
                                         alt="logo">
                                </div>
                            </div>
                        </div>
            ...
            Now press delete key from your keyboard or click more icon then click Remove Block.</span>
                            <h4>&#10140; Select row then Duplicate row ctrl + shift + D or click more icon then
                                Duplicate add change the
                                information same process</h4>
                            <div class="pt-20">
                                <iframe width="560" height="315" src="https://www.youtube.com/embed/p1WW-auijOA"
                                        frameborder="0"
                    ...
                    <div class="col-md-4">
                        <div class="pro_fiture">
                            ...
                            <ul>
                                ...
                                <li>Set any Link(anchor) <strong>rel</strong> value(<strong>nofollow,</strong>
                                    sponsored, ugc)
                                </li>
                                <li>Will be able to use <strong>list</strong> and change <strong>list before
                                        icon</strong>.
                                </li>
                                <li>One click demo import</li>
                                <li><strong>Continue to enjoy the premium table that you created for front-end even
                                        after your license
                                        expires</strong>.
                                </li>
                                <li>1 Year of Premium Support</li>
                            </ul>
                            <div class="demo"><a href="./admin.php?page=nichetablewpwp-pricing">Get NicheTable
                                    Premium</a></div>
                            <div>
                                <p style="color: #ff4c4c; text-align: center; border: 1px dashed red; padding: 5px 5px 8px; line-height: 1.2;">
                                    Do you know According to google analytics more than 55% of visitor came from
                                    mobile?</p>
                            </div>
                            <h3 class="text-center">NicheTable Premium Mobile <br/>Version Style Look-like <h3>
                                    <img class="mobailimg"
                                         src="https://wpdab.com/img/nichetable/mobail-responsive-img.png" alt="logo">
                        </div>
